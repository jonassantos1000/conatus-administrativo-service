...
CREATE TABLE TB_PLANO_CONTRATACAO (
    IDENT BIGINT GENERATED BY DEFAULT AS IDENTITY,
    DT_ATUALIZACAO TIMESTAMP(6) WITH TIME ZONE,
    DT_CONTRATACAO TIMESTAMP(6) WITH TIME ZONE,
    DT_EXPIRACAO TIMESTAMP(6) WITH TIME ZONE,
    ID_DOM_SITUACAO BIGINT,
    ID_LICENCA INTEGER,
    ID_TENANT BIGINT,
    PRIMARY KEY (IDENT),
    CONSTRAINT FK_DOM_SITUACAO_CONTRATACAO FOREIGN KEY (ID_DOM_SITUACAO) REFERENCES TB_DOMINIO(IDENT),
    CONSTRAINT FK_ID_LICENCA FOREIGN KEY (ID_LICENCA) REFERENCES TB_LICENCA(IDENT),
    CONSTRAINT FK_ID_TENANT_LICENCA FOREIGN KEY (ID_TENANT) REFERENCES TB_TENANT(IDENT)
);
